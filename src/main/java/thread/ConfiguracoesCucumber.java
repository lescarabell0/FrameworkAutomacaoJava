...
public class ConfiguracoesCucumber {
	...
	public List<String> definirTagsEpluginsCucumber(List<String> tags, String pluginReportJunit,
			String pluginReportJsonCucumber) {
	...
	private void definirPlugins(String pluginReportJunit, String pluginReportJsonCucumber) {
		...
		if (pluginReportJunit != null) {
			pluginList.add("--plugin");
			pluginList.add(pluginReportJunit);
		} else {
			logger.info("Parâmetro pluginReportJunit está nulo!");
		}

		if (pluginReportJsonCucumber != null) {
			pluginList.add("--plugin");
			pluginList.add(pluginReportJsonCucumber);
		} else {
	...
	public RuntimeOptions definirCaminhoFeaturesEsteps(List<String> pluginList, String caminhoDasFeatures,
			String pacoteSteps) {
	...
	public ClassLoader definirClassLoader() {
		return CucumberExecuteTest.class.getClassLoader();
	}

	public ResourceLoader definirResourceLoader() {
		return new MultiLoader(definirClassLoader());
	}

	public ClassFinder definirClassFinder() {
		return new ResourceLoaderClassFinder(definirResourceLoader(), definirClassLoader());
	}

	public void configurarOpcoes(String pluginReportJunit, String pluginReportJsonCucumber, List<String> tags,
			String caminhoDasFeatures, String pacoteSteps) {
